...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('admin.highlights.create') }}" class="btn btn-danger btn-sm">
    ...
    <div class="table-responsive shadow-sm bg-white rounded-top">
        <table class="table table-hover">
            ...
            <tr>
                <th scope="col">ID</th>
                <th scope="col" width="5">@lang('app.sortOrder')</th>
            ...
            @foreach($objs->sortBy('sort_order')->sortBy('sort_order') as $obj)
                <tr>
                    <td>{{ $obj->id }}</td>
                    <td>{{ $obj->sort_order }}</td>
                    <td>
                        <a href="{{ route('admin.highlights.index', $obj->slug) }}" class="text-decoration-none">
                    ...
                    <td>
                        <a href="{{ route('admin.highlights.edit', $obj->id) }}" class="btn btn-success btn-sm my-1">
                            <i class="bi-pencil"></i>
                        </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('admin.highlights.destroy', $obj->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            @honeypot
